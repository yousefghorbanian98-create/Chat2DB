...
export function installBrowserMock(): void {
  ...
  window.api = {
    ...
    updates: { state: async () => ({status:'idle',currentVersion:'1.1.1',canAutoInstall:true}), check: async () => ({status:'not-available',currentVersion:'1.1.1',canAutoInstall:true}), download: async () => ({status:'downloaded',currentVersion:'1.1.1',availableVersion:'1.2.0',percent:100,canAutoInstall:true}), install: async () => undefined },
