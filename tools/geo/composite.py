...
label((pl[0][0]+pl[2][0])/2, lab_pilot_y, "پیلوت: ۳ مغازه + ۴ پارکینگ (۲۲۳ m²)", (225,240,255), 27)
label((tw[0][0]+tw[2][0])/2, (tw[0][1]+tw[2][1])/2 - 20, "برج ۴ طبقه مسکونی", (255,240,220), 23, bg=(90,45,0,190))
label((pp[0][0]+pp[1][0])/2, max(p[1] for p in pp) + 24, "۲۷٫۹۳", (255,225,225), 23)
label(max(p[0] for p in pp) + 42, (pp[2][1]+pp[3][1])/2, "۱۰٫۳۶", (255,225,225), 21, bg=(0,0,0,150))
label((pp[0][0]+pp[1][0])/2 + 60, (pp[0][1]+pp[1][0])/2*0 + (pp[1][1]+pp[2][1])/2 + 22, "۱۰٫۰۷", (255,225,225), 21, bg=(0,0,0,150))
label((pp[3][0]+pp[4][0])/2, min(p[1] for p in pp) - 62, "۲۷٫۹۳", (255,225,225), 23)
...
# عنوان و اعتبار
t1 = fa("جانمایی واقعی طرح روی زمین")
