...
BOXES = [
    ...
    ("BASE_CORE", 0, 8.27, 0, 4.2, 13.37, 4.5, "core"),
    ("SHOP", 4.2, 7.37, 0.05, 13.289, 13.37, 4.5, "shopfront"),
    ("SHOP", 13.289, 7.37, 0.05, 22.377, 13.37, 4.5, "shopfront"),
    ("SHOP", 22.377, 7.37, 0.05, 31.466, 13.37, 4.5, "shopfront"),
    ("SHOP", 31.466, 7.37, 0.05, 40.555, 13.37, 4.5, "shopfront"),
    ("F1_SLAB", 0, 2.67, 4.2, 40.555, 13.37, 4.5, "slab"),
    ("F1_WALL_W", 0, 2.67, 4.5, 0.3, 13.37, 7.4, "facade"),
    ("F1_WALL_E", 40.255, 2.67, 4.5, 40.555, 13.37, 7.4, "facade"),
    ("F1_WALL_S", 0, 4.87, 4.5, 40.555, 5.12, 7.4, "facade"),
    ("F1_WALL_N", 0, 13.07, 4.5, 40.555, 13.37, 7.4, "facade"),
    ("F1_CORE", 0, 8.27, 4.5, 4.2, 13.37, 7.4, "core"),
    ("F1_PARTY", 4.1, 4.87, 4.5, 4.3, 12.07, 7.4, "concrete"),
    ("F1_BALC", 4.2, 2.67, 4.5, 13.289, 4.87, 4.62, "balcony"),
    ("F1_RAIL", 4.2, 2.67, 4.5, 13.289, 2.79, 5.6, "railing"),
    ("F1_RAIL_S", 4.2, 2.67, 4.5, 4.32, 4.87, 5.6, "railing"),
    ("F1_RAIL_E", 13.169, 2.67, 4.5, 13.289, 4.87, 5.6, "railing"),
    ("F1_PARTY", 13.189, 4.87, 4.5, 13.389, 12.07, 7.4, "concrete"),
    ("F1_BALC", 13.289, 2.67, 4.5, 22.377, 4.87, 4.62, "balcony"),
    ("F1_RAIL", 13.289, 2.67, 4.5, 22.377, 2.79, 5.6, "railing"),
    ("F1_RAIL_S", 13.289, 2.67, 4.5, 13.409, 4.87, 5.6, "railing"),
    ("F1_RAIL_E", 22.257, 2.67, 4.5, 22.377, 4.87, 5.6, "railing"),
    ("F1_PARTY", 22.277, 4.87, 4.5, 22.477, 12.07, 7.4, "concrete"),
    ("F1_BALC", 22.377, 2.67, 4.5, 31.466, 4.87, 4.62, "balcony"),
    ("F1_RAIL", 22.377, 2.67, 4.5, 31.466, 2.79, 5.6, "railing"),
    ("F1_RAIL_S", 22.377, 2.67, 4.5, 22.497, 4.87, 5.6, "railing"),
    ("F1_RAIL_E", 31.346, 2.67, 4.5, 31.466, 4.87, 5.6, "railing"),
    ("F1_PARTY", 31.366, 4.87, 4.5, 31.566, 12.07, 7.4, "concrete"),
    ("F1_BALC", 31.466, 2.67, 4.5, 40.555, 4.87, 4.62, "balcony"),
    ("F1_RAIL", 31.466, 2.67, 4.5, 40.555, 2.79, 5.6, "railing"),
    ("F1_RAIL_S", 31.466, 2.67, 4.5, 31.586, 4.87, 5.6, "railing"),
    ("F1_RAIL_E", 40.435, 2.67, 4.5, 40.555, 4.87, 5.6, "railing"),
    ("F2_SLAB", 0, 2.67, 7.1, 40.555, 13.37, 7.4, "slab"),
    ("F2_WALL_W", 0, 2.67, 7.4, 0.3, 13.37, 10.3, "facade"),
    ("F2_WALL_E", 40.255, 2.67, 7.4, 40.555, 13.37, 10.3, "facade"),
    ("F2_WALL_S", 0, 4.87, 7.4, 40.555, 5.12, 10.3, "facade"),
    ("F2_WALL_N", 0, 13.07, 7.4, 40.555, 13.37, 10.3, "facade"),
    ("F2_CORE", 0, 8.27, 7.4, 4.2, 13.37, 10.3, "core"),
    ("F2_PARTY", 4.1, 4.87, 7.4, 4.3, 12.07, 10.3, "concrete"),
    ("F2_BALC", 4.2, 2.67, 7.4, 13.289, 4.87, 7.52, "balcony"),
    ("F2_RAIL", 4.2, 2.67, 7.4, 13.289, 2.79, 8.5, "railing"),
    ("F2_RAIL_S", 4.2, 2.67, 7.4, 4.32, 4.87, 8.5, "railing"),
    ("F2_RAIL_E", 13.169, 2.67, 7.4, 13.289, 4.87, 8.5, "railing"),
    ("F2_PARTY", 13.189, 4.87, 7.4, 13.389, 12.07, 10.3, "concrete"),
    ("F2_BALC", 13.289, 2.67, 7.4, 22.377, 4.87, 7.52, "balcony"),
    ("F2_RAIL", 13.289, 2.67, 7.4, 22.377, 2.79, 8.5, "railing"),
    ("F2_RAIL_S", 13.289, 2.67, 7.4, 13.409, 4.87, 8.5, "railing"),
    ("F2_RAIL_E", 22.257, 2.67, 7.4, 22.377, 4.87, 8.5, "railing"),
    ("F2_PARTY", 22.277, 4.87, 7.4, 22.477, 12.07, 10.3, "concrete"),
    ("F2_BALC", 22.377, 2.67, 7.4, 31.466, 4.87, 7.52, "balcony"),
    ("F2_RAIL", 22.377, 2.67, 7.4, 31.466, 2.79, 8.5, "railing"),
    ("F2_RAIL_S", 22.377, 2.67, 7.4, 22.497, 4.87, 8.5, "railing"),
    ("F2_RAIL_E", 31.346, 2.67, 7.4, 31.466, 4.87, 8.5, "railing"),
    ("F2_PARTY", 31.366, 4.87, 7.4, 31.566, 12.07, 10.3, "concrete"),
    ("F2_BALC", 31.466, 2.67, 7.4, 40.555, 4.87, 7.52, "balcony"),
    ("F2_RAIL", 31.466, 2.67, 7.4, 40.555, 2.79, 8.5, "railing"),
    ("F2_RAIL_S", 31.466, 2.67, 7.4, 31.586, 4.87, 8.5, "railing"),
    ("F2_RAIL_E", 40.435, 2.67, 7.4, 40.555, 4.87, 8.5, "railing"),
    ("F3_SLAB", 0, 2.67, 10, 40.555, 13.37, 10.3, "slab"),
    ("F3_WALL_W", 0, 2.67, 10.3, 0.3, 13.37, 13.2, "facade"),
    ("F3_WALL_E", 40.255, 2.67, 10.3, 40.555, 13.37, 13.2, "facade"),
    ("F3_WALL_S", 0, 4.87, 10.3, 40.555, 5.12, 13.2, "facade"),
    ("F3_WALL_N", 0, 13.07, 10.3, 40.555, 13.37, 13.2, "facade"),
    ("F3_CORE", 0, 8.27, 10.3, 4.2, 13.37, 13.2, "core"),
    ("F3_PARTY", 4.1, 4.87, 10.3, 4.3, 12.07, 13.2, "concrete"),
    ("F3_BALC", 4.2, 2.67, 10.3, 13.289, 4.87, 10.42, "balcony"),
    ("F3_RAIL", 4.2, 2.67, 10.3, 13.289, 2.79, 11.4, "railing"),
    ("F3_RAIL_S", 4.2, 2.67, 10.3, 4.32, 4.87, 11.4, "railing"),
    ("F3_RAIL_E", 13.169, 2.67, 10.3, 13.289, 4.87, 11.4, "railing"),
    ("F3_PARTY", 13.189, 4.87, 10.3, 13.389, 12.07, 13.2, "concrete"),
    ("F3_BALC", 13.289, 2.67, 10.3, 22.377, 4.87, 10.42, "balcony"),
    ("F3_RAIL", 13.289, 2.67, 10.3, 22.377, 2.79, 11.4, "railing"),
    ("F3_RAIL_S", 13.289, 2.67, 10.3, 13.409, 4.87, 11.4, "railing"),
    ("F3_RAIL_E", 22.257, 2.67, 10.3, 22.377, 4.87, 11.4, "railing"),
    ("F3_PARTY", 22.277, 4.87, 10.3, 22.477, 12.07, 13.2, "concrete"),
    ("F3_BALC", 22.377, 2.67, 10.3, 31.466, 4.87, 10.42, "balcony"),
    ("F3_RAIL", 22.377, 2.67, 10.3, 31.466, 2.79, 11.4, "railing"),
    ("F3_RAIL_S", 22.377, 2.67, 10.3, 22.497, 4.87, 11.4, "railing"),
    ("F3_RAIL_E", 31.346, 2.67, 10.3, 31.466, 4.87, 11.4, "railing"),
    ("F3_PARTY", 31.366, 4.87, 10.3, 31.566, 12.07, 13.2, "concrete"),
    ("F3_BALC", 31.466, 2.67, 10.3, 40.555, 4.87, 10.42, "balcony"),
    ("F3_RAIL", 31.466, 2.67, 10.3, 40.555, 2.79, 11.4, "railing"),
    ("F3_RAIL_S", 31.466, 2.67, 10.3, 31.586, 4.87, 11.4, "railing"),
    ("F3_RAIL_E", 40.435, 2.67, 10.3, 40.555, 4.87, 11.4, "railing"),
    ("ROOF_SLAB", 0, 2.67, 12.9, 40.555, 13.37, 13.2, "roof"),
    ("ROOF_PARAPET_W", 0, 2.67, 13.2, 0.25, 13.37, 14.2, "parapet"),
    ("ROOF_PARAPET_E", 40.305, 2.67, 13.2, 40.555, 13.37, 14.2, "parapet"),
    ("ROOF_PARAPET_S", 0, 2.67, 13.2, 40.555, 2.92, 14.2, "parapet"),
    ("ROOF_PARAPET_N", 0, 13.12, 13.2, 40.555, 13.37, 14.2, "parapet"),
    ("ROOF_CORE", 0, 8.27, 13.2, 4.2, 13.37, 16, "core"),
]
STREETS = [
...
CAMERAS = [
    ("نما-خیابان", (46.0, -26.0, 1.7), (18.0, 8.0, 7.0), 26),
    ("نما-سه-رخ", (-12.0, -18.0, 1.7), (18.0, 7.0, 6.0), 28),
