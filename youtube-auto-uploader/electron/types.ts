...
export interface Channel {id:number;youtube_channel_id:string;channel_name:string|null;channel_handle:string|null;thumbnail_url:string|null;interval_hours:number;auto_upload:number;privacy:Privacy;is_active:number;last_checked_at:string|null;last_error:string|null;custom_cron:string|null;etag:string|null;next_retry_at:string|null;consecutive_failures:number}
