...
export function installBrowserMock(): void {
  ...
  window.api = {
    ...
    clipper: { start: async () => handle(), renderSuggested: async () => handle(), cancel: async () => true, job: async () => null, clips: async () => clips, update: async () => undefined, export: async () => null, upload: async () => handle() },
