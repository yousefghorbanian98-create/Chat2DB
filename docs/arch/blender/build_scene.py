...
BOXES = [
    ("SITE_PLOT", 0, 0, -0.02, 40.57, 13.37, 0, "site"),
    ("PODIUM_PARKING", 0, 2.67, 0, 22.6, 13.37, 5.4, "concrete"),
    ("PODIUM_SHOPS", 22.6, 2.67, 0, 40.57, 13.37, 5.4, "shopfront"),
    ("PODIUM_TERRACE", 22.572, 2.67, 5.1, 40.57, 13.37, 5.4, "terrace"),
    ("FLOOR_1_WEST_WING", 0, 5.07, 5.4, 9.186, 13.37, 8.3, "facade"),
    ("FLOOR_1_EAST_WING", 13.386, 5.07, 5.4, 22.572, 13.37, 8.3, "facade"),
    ("FLOOR_1_CORE", 9.186, 5.07, 5.4, 13.386, 10.37, 8.3, "core"),
    ("FLOOR_1_SLAB_W", 0, 2.67, 5.1, 9.186, 13.37, 5.4, "slab"),
    ("FLOOR_1_SLAB_E", 13.386, 2.67, 5.1, 22.572, 13.37, 5.4, "slab"),
    ("FLOOR_1_BALCONY_W", 0, 2.67, 5.1, 6.56, 5.07, 5.4, "balcony"),
    ("FLOOR_1_BALCONY_E", 16.012, 2.67, 5.1, 22.572, 5.07, 5.4, "balcony"),
    ("FLOOR_1_RAIL_W", 0, 2.67, 5.4, 6.56, 2.79, 8.3, "railing"),
    ("FLOOR_1_RAIL_E", 16.012, 2.67, 5.4, 22.572, 2.79, 8.3, "railing"),
    ("FLOOR_2_WEST_WING", 0, 5.07, 8.3, 9.186, 13.37, 11.2, "facade"),
    ("FLOOR_2_EAST_WING", 13.386, 5.07, 8.3, 22.572, 13.37, 11.2, "facade"),
    ("FLOOR_2_CORE", 9.186, 5.07, 8.3, 13.386, 10.37, 11.2, "core"),
    ("FLOOR_2_SLAB_W", 0, 2.67, 8, 9.186, 13.37, 8.3, "slab"),
    ("FLOOR_2_SLAB_E", 13.386, 2.67, 8, 22.572, 13.37, 8.3, "slab"),
    ("FLOOR_2_BALCONY_W", 0, 2.67, 8, 6.56, 5.07, 8.3, "balcony"),
    ("FLOOR_2_BALCONY_E", 16.012, 2.67, 8, 22.572, 5.07, 8.3, "balcony"),
    ("FLOOR_2_RAIL_W", 0, 2.67, 8.3, 6.56, 2.79, 11.2, "railing"),
    ("FLOOR_2_RAIL_E", 16.012, 2.67, 8.3, 22.572, 2.79, 11.2, "railing"),
    ("FLOOR_3_WEST_WING", 0, 5.07, 11.2, 9.186, 13.37, 14.1, "facade"),
    ("FLOOR_3_EAST_WING", 13.386, 5.07, 11.2, 22.572, 13.37, 14.1, "facade"),
    ("FLOOR_3_CORE", 9.186, 5.07, 11.2, 13.386, 10.37, 14.1, "core"),
    ("FLOOR_3_SLAB_W", 0, 2.67, 10.9, 9.186, 13.37, 11.2, "slab"),
    ("FLOOR_3_SLAB_E", 13.386, 2.67, 10.9, 22.572, 13.37, 11.2, "slab"),
    ("FLOOR_3_BALCONY_W", 0, 2.67, 10.9, 6.56, 5.07, 11.2, "balcony"),
    ("FLOOR_3_BALCONY_E", 16.012, 2.67, 10.9, 22.572, 5.07, 11.2, "balcony"),
    ("FLOOR_3_RAIL_W", 0, 2.67, 11.2, 6.56, 2.79, 14.1, "railing"),
    ("FLOOR_3_RAIL_E", 16.012, 2.67, 11.2, 22.572, 2.79, 14.1, "railing"),
    ("FLOOR_4_WEST_WING", 0, 5.07, 14.1, 9.186, 13.37, 17, "facade"),
    ("FLOOR_4_EAST_WING", 13.386, 5.07, 14.1, 22.572, 13.37, 17, "facade"),
    ("FLOOR_4_CORE", 9.186, 5.07, 14.1, 13.386, 10.37, 17, "core"),
    ("FLOOR_4_SLAB_W", 0, 2.67, 13.8, 9.186, 13.37, 14.1, "slab"),
    ("FLOOR_4_SLAB_E", 13.386, 2.67, 13.8, 22.572, 13.37, 14.1, "slab"),
    ("FLOOR_4_BALCONY_W", 0, 2.67, 13.8, 6.56, 5.07, 14.1, "balcony"),
    ("FLOOR_4_BALCONY_E", 16.012, 2.67, 13.8, 22.572, 5.07, 14.1, "balcony"),
    ("FLOOR_4_RAIL_W", 0, 2.67, 14.1, 6.56, 2.79, 17, "railing"),
    ("FLOOR_4_RAIL_E", 16.012, 2.67, 14.1, 22.572, 2.79, 17, "railing"),
    ("FLOOR_5_WEST_WING", 0, 5.07, 17, 9.186, 13.37, 19.9, "facade"),
    ("FLOOR_5_EAST_WING", 13.386, 5.07, 17, 22.572, 13.37, 19.9, "facade"),
    ("FLOOR_5_CORE", 9.186, 5.07, 17, 13.386, 10.37, 19.9, "core"),
    ("FLOOR_5_SLAB_W", 0, 2.67, 16.7, 9.186, 13.37, 17, "slab"),
    ("FLOOR_5_SLAB_E", 13.386, 2.67, 16.7, 22.572, 13.37, 17, "slab"),
    ("FLOOR_5_BALCONY_W", 0, 2.67, 16.7, 6.56, 5.07, 17, "balcony"),
    ("FLOOR_5_BALCONY_E", 16.012, 2.67, 16.7, 22.572, 5.07, 17, "balcony"),
    ("FLOOR_5_RAIL_W", 0, 2.67, 17, 6.56, 2.79, 19.9, "railing"),
    ("FLOOR_5_RAIL_E", 16.012, 2.67, 17, 22.572, 2.79, 19.9, "railing"),
    ("SHAFT_WALL_W", 9.036, 10.37, 5.4, 9.186, 13.37, 19.9, "core"),
    ("SHAFT_WALL_E", 13.386, 10.37, 5.4, 13.536, 13.37, 19.9, "core"),
    ("SHAFT_WALL_S", 9.186, 10.22, 5.4, 13.386, 10.37, 19.9, "core"),
    ("ROOF_SLAB", 0, 5.07, 19.6, 22.572, 13.37, 19.9, "roof"),
    ("ROOF_PARAPET", 0, 13.12, 19.9, 22.572, 13.37, 20.9, "parapet"),
    ("TERRACE_RAIL", 22.572, 2.67, 5.4, 40.57, 2.82, 6.5, "railing"),
    ("ENTRANCE_CANOPY", 9.186, 13.37, 0, 11.786, 15.87, 3.2, "concrete"),
    ("SHOP_1_SIGN", 22.6, 13.27, 3.4, 28.59, 14.97, 3.55, "sign"),
    ("SHOP_2_SIGN", 28.59, 13.27, 3.4, 34.58, 14.97, 3.55, "sign"),
    ("SHOP_3_SIGN", 34.58, 13.27, 3.4, 40.57, 14.97, 3.55, "sign"),
]
STREETS = [
